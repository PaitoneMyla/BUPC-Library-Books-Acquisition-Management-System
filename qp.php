...
<section>
   ...
   <div class='container'>
      <h1 style="color: white; margin-top: 100px; font-family: garamond;">Quality Policy</h1>
       <img src="img/qp.png" alt="" style="margin-top: 20px; margin-bottom: 20px; margin-left: 250px;">
   </div>
    </section>
