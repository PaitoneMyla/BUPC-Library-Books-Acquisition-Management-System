...
<section>
   ...
   <div class='container'>
      <h1 style="color: white; margin-top: 100px; font-family: garamond;">Vision Mission</h1>
       <img src="img/vm.png" alt="" style="margin-top: 20px; margin-bottom: 20px; margin-left: 250px;">
   </div>
    </section>
